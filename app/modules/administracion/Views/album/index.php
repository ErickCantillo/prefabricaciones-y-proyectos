			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							<td><?= $content->galeria_titulo ?></td>
							<td><?= $content->galeria_descripcion ?></td>
							<td><?= $content->galeria_imagen ?></td>
							<td class="text-end">
								<a class="btn btn-rosado btn-sm" href="/administracion/foto/?album=<?= $id ?>"
