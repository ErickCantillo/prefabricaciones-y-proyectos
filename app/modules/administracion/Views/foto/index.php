			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id =  $content->id; ?>
						<tr>
							<td><?= $content->foto_titulo; ?></td>
							<td><?= $content->foto_descripcion; ?></td>
							<td>
								<?php if ($content->foto_path) { ?>
									<img src="/images/<?= $content->foto_path; ?>" class="img-thumbnail thumbnail-administrator" />
								<?php } ?>
							<td class="text-end">
								<div>
